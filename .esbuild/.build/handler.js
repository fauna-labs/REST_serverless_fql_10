...
var require_node = __commonJS({
  "node_modules/fauna/dist/node/index.js"(exports2, module2) {
    "use strict";
...
module.exports.createBook = async (event, context, callback) => {
  try {
    ...
    const response = await client.query(
      import_fauna.fql`Inventory.create(${data})`
    );
    return {
      statusCode: 200,
